...
!function (t, e, i, n) {
  ...
  var s = "ellipsis",
    ...
    excerpted: "excerpted.ellipsis"
      ...
      l = function () {
    function i(e) {
      var s = arguments.length > 1 && arguments[1] !== n ? arguments[1] : {};
      _classCallCheck(this, i), this.element = t(e), this.options = Object.assign({}, i.DEFAULTS, s), this.text = this.element.text(), this._resizeTimeout = null, this._resizeHandler = this._updateOnResize.bind(this), this.init();
    }

    return _createClass(i, [{
      key: "init",
      value: function () {
        this.element.trigger(r.initialize), this.element.trigger(r.excerpt), "lines" === this.options.type ? this._excerptLines(this.options.count) : this._excerptChars(this.options.count), "lines" === this.options.type && t(e).on("resize", this.element.selector, this._resizeHandler), this.element.trigger(r.initialized);
      }
    }, {
      key: "update",
      value: function () {
        return this.element.trigger(r.update), "lines" === this.options.type ? this._excerptLines(this.options.count) : this._excerptChars(this.options.count), this.element.trigger(r.updated), !0;
      }
    }, {
      key: "reset",
      value: function (t) {
        t.text && (this.text = t.text), t.type && (this.options.type = t.type), t.count && (this.options.count = t.count), Object.keys(t).length > 0 && (this.element.text(this.text), this.update());
      }
    }, {
      key: "destroy",
      value: function () {
        t(e).off("resize", this._resizeHandler), this.element.text(this.text), this.element.off(r.namespace);
      }
    }, {
      key: "_excerptChars",
      value: function (t) {
        return t <= 0 ? new Error("Number of chars to be shown is equal to or less than zero !!") : t >= this.text.length ? null : (this.element.html(this.text.slice(0, t) + "..."), this.element.trigger(r.excerpted), !0);
      }
    }, {
      key: "_excerptLines",
      value: function (t) {
        var e = void 0,
            i = this.element.text(this.text).height(),
            n = void 0,
            s = 0,
            o = this.text.length - 1,
            l = void 0;
        if (e = this.element.text("w").height(), n = e * t, i <= n) return this.element.text(this.text), !1;

        for (; s <= o;) l = Math.floor((s + o) / 2), this.element.text(this.text.slice(0, l)), this.element.height() <= n ? s = l + 1 : o = l - 1;

        return this.element.text(this.text.slice(0, l - 3) + "..."), this.element.trigger(r.excerpted), !0;
      }
    }, {
      key: "_updateOnResize",
      value: function () {
  ...
  t.fn[s] = function (e) {
    var i = arguments;
    if (e === n || "object" === ("undefined" == typeof e ? "undefined" : _typeof(e))) return this.each(function () {
      t.data(this, "plugin_" + s) || t.data(this, "plugin_" + s, new l(this, e));
    });
    ...
    if ("string" == typeof e && "_" !== e[0] && "init" !== e) {
      ...
      return this.each(function () {
        ...
        n instanceof l && "function" == typeof n[e] && (o = n[e].apply(n, Array.prototype.slice.call(i, 1))), "destroy" === e && t.data(this, "plugin_" + s, null);
      }), o !== n ? o : this;
    }
  }, t(i).ready(function () {
    var e = t('[data-toggle="ellipsis"]');
    e.each(function (e, i) {
      var s = t(i),
          o = {};
      s.data("type") !== n && (o.type = s.data("type")), s.data("count") !== n && (o.count = s.data("count")), s.ellipsis(o);
    });
  });
...
jQuery(document).ready(function ($) {
  ...
  svg4everybody(); // Detect touch devices
  ...
  } // Show/hide subnavigation on touch devices


  if (isTouchDevice() && $('body').width() > 991) {
    $(document).on('click', '.nav__item_submenu .nav__link', subnavToggle);
  }

  function subnavToggle() {
    var $items = $('.nav__item_submenu');
    var $item = $(this).closest('.nav__item_submenu');

    if (!$item.hasClass('nav__item_opened')) {
      $items.removeClass('nav__item_opened');
      $item.addClass('nav__item_opened');
    } else {
      $item.removeClass('nav__item_opened');
    }
  }

  $(document).mouseup(function (e) {
    if (isTouchDevice() && $('body').width() > 991) {
      var div = $(".nav__sub-list");
      var link = $(".nav__link");
      var el = $(".nav__item_submenu");

      if (!div.is(e.target) && div.has(e.target).length === 0 && !link.is(e.target)) {
        el.removeClass('nav__item_opened');
      }
    }
  }); // Sticky header

  var header = $('.header:not(.header_static)');
  var scrollPrev = 0;
  ...
  function headerScroll() {
    ...
    if (scrolled > 70 && scrolled > scrollPrev) {
      ...
      $('.nav__item_opened').removeClass('nav__item_opened');
    } else {
  ...
  Stickyfill.add(stickyElements); // Side anchor navigation

  var app = app || {};
  app.state = false;
  $(document).on('click', '.lwptoc_item > a', sideNav);
  $(window).on('scroll resize', sideNavActive);
  $('.js-anchor-nav .lwptoc_items > .lwptoc_itemWrap > .lwptoc_item:first-child').addClass('active');
  setTimeout(function () {
    sideNavActive();
  }, 500);
  ...
  function sideNav(e) {
    ...
    $('li.lwptoc_item').removeClass('active');
    $element.closest('li.lwptoc_item').addClass('active');

    if (dest !== undefined && dest !== '' && $(dest).length) {
      var destIndent = $(dest).offset().top - 20;
      var destPosition = destIndent;

      if (destIndent < currentTop) {
        destPosition = destIndent - headerHeight;
      }

      $('html, body').animate({
        scrollTop: destPosition
      }, 600);
    }
  ...
  function sideNavActive() {
    if (app.state) return;
    var $sideContent = $('.js-anchor-content');
    var $sideContentItem = $sideContent.find('h2,h3');
    var $sideNav = $('.js-anchor-nav');
    var $sideNavItem = $sideNav.find('li.lwptoc_item');
    var headerHeight = $('.header').outerHeight();
    $($sideContentItem).each(function () {
      var top = $(window).scrollTop();
      var sideId = $(this).find('span').attr('id');
      var sideHref = $('.js-anchor-nav .lwptoc_item > a[href="#' + sideId + '"]');
      var sideTop = $(this).offset().top - headerHeight - 35;

      if (top > sideTop) {
        $sideNavItem.removeClass('active');
        sideHref.closest('li.lwptoc_item').addClass('active');
      }
    });
  } // Team slider


  var $teamSlider = $('.slider_team .slider__container');
  ...
  if ($teamSlider.length) {
    $teamSlider.slick({
      ...
      slidesToScroll: 5,
      arrows: true,
      prevArrow: '<button type="button" class="slider__arrow slider__arrow_prev"><svg class="slider__icon" width="16" height="24"><use xlink:href="/wp-content/themes/sam/img/sprite.svg#icon-arrow"></use></svg></button>',
      nextArrow: '<button type="button" class="slider__arrow slider__arrow_next"><svg class="slider__icon" width="16" height="24"><use xlink:href="/wp-content/themes/sam/img/sprite.svg#icon-arrow"></use></svg></button>',
      responsive: [{
        breakpoint: 1172,
        settings: {
          slidesToShow: 5,
  ...
  var $reviewSlider = $('.slider_reviews .slider__container');
  ...
  if ($reviewSlider.length) {
    $reviewSlider.slick({
      ...
      arrows: true,
      dots: true,
      prevArrow: '<button type="button" class="slider__arrow slider__arrow_prev"><svg class="slider__icon" width="15" height="28"><use xlink:href="/wp-content/themes/sam/img/sprite.svg#icon-arrow-slider"></use></svg></button>',
      nextArrow: '<button type="button" class="slider__arrow slider__arrow_next"><svg class="slider__icon" width="15" height="28"><use xlink:href="/wp-content/themes/sam/img/sprite.svg#icon-arrow-slider"></use></svg></button>',
      responsive: [{
        breakpoint: 1200,
        settings: {
          arrows: false
  ...
  var $storiesSlider = $('.slider_stories .slider__container');
 ...
 var $clientsSlider = $('.slider_clients .slider__container'); 
 ...
 $("#contactform_custom_software_solutions_form_success #success_close_con").on('click', function (e) {
    $('#contactform_custom_software_solutions_form_success').hide();
    $('#contactform_custom_software_solutions').show();
  });


  function popupRequestShow(title) {
    var $popup = $('.popup');
    
    $("#contactstartupssupport_form_success").hide();
    $("#contactformletstalk1_form_success").hide();
 ...
 /* $('.request-block__btn').on('click', function (e) {
    var title = $(this).closest('.request-block__button').children('.request-block__title').text();
    popupRequestShow(title);
  });*/
  /* Popup */

  $(document).on('click', '*[data-popup]', popupShow);
  $(document).on('click', '.popup__close, .popup_show', popupClose); // Popup show
  ...
  function popupClose(e) {
    if ($(this).is('.popup__close')) {
      ...
      var $popup = $(this);
      var $popupBox = $popup.find('.popup__box');
  ...
  if ($('.tabs').length) {
    $('.tabs__box:first-child').addClass('tabs__box_opened');
  }

  $(document).on('click', '.tabs__link', tabsToggle);

  function tabsToggle(e) {
    e.preventDefault();
    var $this = $(this);
    var $tabs = $this.closest('.tabs');
    var $tabsItem = $this.closest('.tabs__item');
    $tabs.find('.tabs__box').removeClass('tabs__box_opened');
    ...
    $(clicked).addClass('tabs__box_opened');
  } // prevent links


  $(document).on('click', 'a[href="#"]', linkPrevent);
...
/* GA and YM user IDcollection (START)*/
    window.getGAId = function () {
        var number2 = null;
        try {
            var tracker = ga.getAll()[0];
            number2 = tracker.get('clientId');
        } catch (ex) { }
        return number2;
    }
    
    window.getYmId = async function () {
        var getYmIdPromise = () => {
    
            return new Promise(
                resolve => {
                    try {
                        ym(56800735, 'getClientID', function (clientID) {
                            resolve(clientID);
                        });
                    } catch (ex) {
                        resolve(null);
        ...
        return await getYmIdPromise();
    }
    window.injectAdditionalParamsAndSubmit = (data, submitCallback) => {
        getYmId().then(number1 => {
          try {
            if (!! number1) {
                data.append('number1', number1); //yandex id
            }
            var number2 = getGAId();
            if (!! number2) {
                data.append('number2', number2);  // google id
            }
          } catch (err) {
            console.error(err);
          } finally {
...
/* GA and YM user ID collection (END)*/

  /*popup form*/
  $("#popup-request-form").submit(function () {
    var $form = $(this);
    var $success = $form.closest('.content').find('.contacts-form-success');
    $form.find('.form__error').removeClass('form__error');
    if (this.checkValidity()) {
      $form.find('button[type=submit]').prop('disabled', true); // TODO loading

      var data = new FormData(this);
      injectAdditionalParamsAndSubmit(
        data,
        data => {
          $.ajax({
            //               url: '/ajax.php',
            url: "/wp-admin/admin-ajax.php?action=contactusform1",
            method: 'POST',
            data: data,
            contentType: false,
            processData: false,
            complete: function complete() {
              $form.find('button[type=submit]').prop('disabled', false); // TODO release
            },
            ...
            error: function error(data) {
              alert(data && data.response ? data.response : 'Request error');
            }
          })
            .done(function(data){
                ...
                // goals to analytics
                try {
                    dataLayer.push({'event':'send-ajax-form','eventCategory':'form_send','eventAction':'general-form'});
                    ga('send', 'event', 'Form', 'request-full-form');
                 //   dataLayer.push({'event': 'send-request','eventCategory': 'SubmitGeneralForm','eventAction': 'formsend'});
    				} catch (ex) { }
				try {
                    ym(56800735,'reachGoal','request-full-form');
    				} catch (ex) { }
              });
      ...
      $(this).find(':input').each(function () {
        if (!this.validity.valid) {
          $(this).closest('.form__row,.form__bottom').addClass('form__error');
        }
      });
    }
  ...
  $("#contact-form1").submit(function () {
      ...
      injectAdditionalParamsAndSubmit(
        ...
        data => {
          $.ajax({
            ...
            success: function success(data) {
              // TODO success popup
              var $popupSuccess = $('#popup_form_success');
              $popupSuccess.addClass('popup_show');
              $('body').addClass('overlayed');
            },
            error: function error(data) {
              alert(data && data.response ? data.response : 'Request error');
    ...
    /* Form contact-form-startups-support START */
/*   $("#contact-form1, #contact-form-startups-support").submit(function () { */

  $("#contactstartupssupport").submit(function () {
    var $form = $(this);
    var id = $form.attr('id');
    $form.find('.form__error').removeClass('form__error');
    ...
    if (this.checkValidity()) {
      ...
      injectAdditionalParamsAndSubmit(
          ...
          data => {
              $.ajax({
                url: "/wp-admin/admin-ajax.php?action="+id,
                method: 'POST',
                data: data,
                contentType: false,
                processData: false,
                ...
                success: function success(data) {
                  // TODO success popup
                  var $popupSuccess = $('#contactstartupssupport_form_success');
                  $('.popup__title').hide();
                  $popupSuccess.show();
                  $form.hide();
                          $form.find('button[type=submit]').text('Send message');
              ...
              .done(function(data){
                ...
                try {
                    dataLayer.push({'event':'send-ajax-form','eventCategory':'form_send','eventAction':'general-form'});
                    ga('send', 'event', 'Form', 'request-startup');
    				} catch (ex) { }
				try {
                    ym(56800735,'reachGoal','request-startup');
    				} catch (ex) { }
              });
          }
    ...
    return false;
      ...
      /* Form contact-form-startups-support END */
...
/*   $("#contact-form1, #contact-form-startups-support").submit(function () { */
  ...
  $("#contactformcloudmigrationanalise").submit(function () {
    var $form = $(this);
    var id = $form.attr('id');
    $form.find('.form__error').removeClass('form__error');
      ...
      injectAdditionalParamsAndSubmit(
          ...
          data => {
              ...
              .done(function(data){
                ...
                try {
                    dataLayer.push({'event':'send-ajax-form','eventCategory':'form_send','eventAction':'general-form'});
                    ga('send', 'event', 'Form', 'request-contactformcloudmigrationanalise');
    				} catch (ex) { }
				try {
                    ym(56800735,'reachGoal','request-contactformcloudmigrationanalise');
    				} catch (ex) { }
              });
          }
    ...
    return false;
      ...
      $("#contactformletstalk").submit(function () {
    var $form = $(this);
    var id = $form.attr('id');
    $form.find('.form__error').removeClass('form__error');
      ...
      injectAdditionalParamsAndSubmit(
          ...
          data => {
              $.ajax({
                ...
                success: function success(data) {
                  // TODO success popup
                  var $popupSuccess = $('.popup-in-lets-talk');                  
                  $popupSuccess.show();
                  $form.find('button[type=submit]').text('Send message');
...
$("#contactformletstalk1").submit(function () {
    var $form = $(this);
    var id = $form.attr('id');
    $form.find('.form__error').removeClass('form__error');
      ...
      injectAdditionalParamsAndSubmit(
          ...
          data => {
              $.ajax({
                ...
                success: function success(data) {
                  // TODO success popup
                  var $popupSuccess = $('#contactformletstalk1_form_success');
                  $('.popup__title--js').hide();
                  $popupSuccess.show();
                  $form.hide();
                          $form.find('button[type=submit]').text('Send message');
              ...
              .done(function(data){
                ...
                try {
                    dataLayer.push({'event':'send-ajax-form','eventCategory':'form_send','eventAction':'general-form'});
                    ga('send', 'event', 'Form', 'request-contactformletstalk1');
    				} catch (ex) { }
				try {
                    ym(56800735,'reachGoal','request-contactformletstalk1');
    				} catch (ex) { }
              });
          }
  ...
  $("#contactform_custom_software_solutions").submit(function () {
    var $form = $(this);
    var id = $form.attr('id');
    $form.find('.form__error').removeClass('form__error');
      ...
      injectAdditionalParamsAndSubmit(
          ...
          data => {
              $.ajax({
                ...
                success: function success(data) {
                  // TODO success popup
                  var $popupSuccess = $('#contactform_custom_software_solutions_form_success');
                  $('.popup__title--js').hide();
                  $popupSuccess.show();
                  $form.hide();
                          $form.find('button[type=submit]').text('Send message');
              ...
              .done(function(data){
                ...
                try {
                    dataLayer.push({'event':'send-ajax-form','eventCategory':'form_send','eventAction':'general-form'});
                    ga('send', 'event', 'Form', 'request-contactform_custom_software_solutions');
    				} catch (ex) { }
				try {
                    ym(56800735,'reachGoal','request-contactform_custom_software_solutions');
    				} catch (ex) { }
              });
          }
    ...
    /* Form contact-form-custom-software-solutions START */
/*   $("#contact-form1, #contact-form-startups-support").submit(function () { */

 
  
      /* Form Form contact-form-custom-software-solutions END */  
  ...
  /* Form Audit All services template - SAP, Sitecore, Magento etc */

  $("#contact-audit-sitecore").submit(function () {
    var $form = $(this);
    $form.find('.form__error').removeClass('form__error');
    ...
    if (this.checkValidity()) {
      ...
      injectAdditionalParamsAndSubmit(
        ...
        data => {
          $.ajax({
            url: "/wp-admin/admin-ajax.php?action=contactauditsitecore",
            method: 'POST',
            data: data,
            contentType: false,
            processData: false,
            ...
            .done(function(data){
                ...
                // goals to analytics
                try {
                    dataLayer.push({'event':'send-ajax-form-audit','eventCategory':'form_send','eventAction':'audit-form'});
                    ga('send', 'event', 'Form', 'request-short-form');
    				} catch (ex) { }
				try {
                    ym(56800735,'reachGoal','request-short-form');
    				} catch (ex) { }
              });
        }
      );
...
/*Sticky line at the top of header (start)*/
/*
 setTimeout(function(){
    $(document).ready(function(){
      ...
      function notice(){
        var wrapper = $('.wrapper');
        if (wrapper.length) {
          wrapper.before( '<div class="top-notice">\n\t<p class="top-notice__text">\n\t\tCheck out our <a href="/startups/">Startup Support Program.</a>\n\t\tRecieve 20% off your first 100 hours.</p>\n\t<span class="top-notice__close"></span>\n</div>');
        }
        setHeight();
      }

function setHeight() {
        var noticeHeight = $('.top-notice').outerHeight();
        $('.top-notice + .wrapper').css('top',  noticeHeight);
        $('.top-notice + .wrapper .header').css('top',  noticeHeight);
        $('.header__container').css('top',  noticeHeight);

        if($('#wpadminbar').length) {
          $('.top-notice').css('top',  '32px');
        }
      }
      ...
      $(document).on('click', '.top-notice__close', function(e){
        e.preventDefault();
        $(this).closest('.top-notice').remove();
        $('.wrapper').css('top',  0);
        $('.wrapper .header').css('top',  0);
        $.cookie('noticeMessageWasOpen', true);
      });
    });

  }, 3000);
*/
/*Sticky line at the top of header (end)*/
...
jQuery(function($) {
	...
	let content_loaded = false,
		content_timer  = setTimeout(preload_content, 5000);
	...
	function preload_content(e) {
		...
		$.getScript('//js.hs-scripts.com/22645856.js');

		const hbspt_handler = $('.hbspt-handler');
		...
		$(window).off('scroll', preload_content);
	...
	if(localStorage.getItem('preload-content')) {
		...
		$(window).on('scroll', preload_content);
